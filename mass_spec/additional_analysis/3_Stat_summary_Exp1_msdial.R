...
target_msd <- read.delim2("./data/msdial_targets.txt", sep = "\t", header = TRUE)
...
indole_group <-  grep(unique(fdata$`Metabolite.name`), pattern = "indole|camalexin|brassinin|glucosinolate|nitrile|auxin|scopoletin|esculetin", ignore.case=TRUE, value = TRUE)
...
write.table(stat_list, "./statistics/targetted_metabolom.txt", sep = "\t", quote = FALSE, row.names = FALSE)
...
geom_point(
  ...
  colour = c_black) +
    ...
    facet_wrap(.~ class + metabolite_name, scale = "free", switch = "x") +
...
ggsave(p, file = paste0(figs, "boxplot_targets.png"),
    units = "in",
    device = "png",
    width = 5,
    height = 5,
...
ggplot(aes(x = genotype, y = (intensity/1000))) +
geom_point(
  size = 0.5, 
  # shape = 21, 
  ...
  colour = c_black) +
    ...
    theme(
      ...
      strip.text.x = element_text(size = 1)) +
    labs(x = "", y = "intensity/1000", fill = "", colour = "", shape = "")

ggsave(p, file = paste0(figs, "boxplot_ra.png"),
    units = "in",
    device = "png",
    width = 7,
    height = 7,
...
ggsave(p, file = paste0(figs, "boxplot_ra_nitriles_thiols.png"),
    units = "in",
    device = "png",
    width = 5,
    height = 5,
...
ggsave(p, file = paste0(figs, "heatmap_ra_nitrile_thiols.png"),
  units = "in",
  device = "png",
  width = 3,
  height = 2.5,
...
ggsave(p, file = paste0(figs, "heatmap_vsCol_nitrile_thiols.png"),
  units = "in",
  device = "png",
  width = 3,
  height = 2.5,
