...
plot_path <- paste0(figs, "/gh/beta_diversity/uspiked/cpcoa/family/")
stat_path <- paste0(stats, "/gh/beta_diversity/uspiked/cpcoa/family/")
out_path <- paste0(out, "/gh/beta_diversity/uspiked/cpcoa/family/")
