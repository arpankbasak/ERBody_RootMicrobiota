...
mclapply(X = c("Extract", "Exudate"), FUN = function(x){
  ...
  temp <- temp[,idy] %>% cbind.data.frame(., lineage_asvb = temp[,c("lineage_family")])
  colnames(temp) <- str_replace_all(colnames(temp), "genotype_", "")
    ...
    labs(x = i, 
      y = j)
    ggsave(plot  = p, file = paste0(figs.out, "/Parwise_",x,"_", j,"_", i,"_asv_logFC.png"), 
                dpi = 600, 
                units = img, 
                device = "png", 
                bg = "transparent", 
...
#   temp <- temp[,(idx+idy)==1] %>% cbind.data.frame(., temp[,c("lineage_asvb", "Atsphere_strain", "cluster")])
...
geom_raster(alpha=1) +
    ...
    ggsave(hmap_ra, filename = paste0(figs.out,"/RA_asv_heatmap_lfc_sorted.png"),
           bg="transparent", 
           width=3, 
           height=8,
           units = img, 
...
# scale_colour_manual(values = c(`FALSE` = NA, `TRUE` = c_black), guide = FALSE) +
    ...
    ggsave(hmap_lfc, filename = paste0(figs.out,"/LFC_asv_heatmap_lfc_km_sorted.png"),
           bg="transparent", 
           width=3, 
           height=8,
           units = img, 
...
scale_colour_manual(values = c(`FALSE` = NA, `TRUE` = c_black), guide = FALSE) +
    ...
    ggsave(hmap_lfc_vSoil, filename = paste0(figs.out,"/LFC_asv_heatmap_lfc_km_sorted_vs_soil.png"),
           bg="transparent", 
           width=4, 
           height=8,
           units = img, 
...
ggsave(bxp, filename = paste0(figs.out,"/LFC_asv_boxplot_DA.png"),
           bg="transparent", 
           width=3, 
           height=3,
           units = img, 
...
theme() +
labs(y="", x="", fill="")
ggsave(temp.temp, filename = paste0(figs.out,"/pyk10_vs_cyp_asv_.png"),
           bg="transparent", 
           width=5, 
           height=5,
           units = img, 
...
scale_fill_gradient2(
    ...
    theme(panel.spacing = unit(0.1, "lines"), 
          ...
          legend.text = element_text(size = 2, hjust = 0.5, vjust = 0.5)) +
    labs(y="", x="", fill="% meanRA"))
    ggsave(hmap_ra, filename = paste0(figs.out,"/RA_asv_heatmap_lfc_sorted_sig.png"),
           bg="transparent", 
           width=3, 
           height=8,
           units = img, 
...
scale_colour_manual(values = c(`TRUE` = c_black, `FALSE` = NA)) +
    ...
    theme(panel.spacing = unit(0.1, "lines"), panel.border = element_rect(fill="transparent", colour=NA),
          ...
          legend.text = element_text(size = 2, hjust = 0.5, vjust = 0.5)) +
    labs(y="", x="", fill=""))
    ggsave(strip_silva, filename = paste0(figs.out,"/SILVA_annotated_lfc_sorted_sig.png"),
           bg="transparent", 
           width=2, 
           height=8,
           units = img, 
...
scale_colour_manual(values = c(`FALSE` = NA, `TRUE` = c_black), guide = FALSE) +
    ...
    theme(panel.spacing = unit(0.1, "lines"), 
          ...
          legend.text = element_text(size = 2, hjust = 0.5, vjust = 0.5)) +
    labs(y="", x="", fill="lfc(vCol-0)"))
    ggsave(hmap_lfc, filename = paste0(figs.out,"/LFC_asv_heatmap_lfc_km_sorted_sig.png"),
           bg="transparent", 
           width=3, 
           height=8,
           units = img, 
...
scale_colour_manual(values = c(`FALSE` = NA, `TRUE` = c_black), guide = FALSE) +
    ...
    theme(panel.spacing = unit(0.1, "lines"), 
          ...
          legend.text = element_text(size = 2, hjust = 0.5, vjust = 0.5)) +
    labs(y="", x="", fill="lfc(vs Soil)"))
    ggsave(hmap_lfc_vSoil, filename = paste0(figs.out,"/LFC_asv_heatmap_lfc_km_sorted_vs_soil_sig.png"),
           bg="transparent", 
           width=3, 
           height=8,
           units = img, 
