...
load(paste0("./data/CAS_DE_asv_E.RData"))
load(paste0("./data/CAS_DE_asv_RP.RData"))
load(paste0("./data/CAS11_DE_asv_E.RData"))
load(paste0("./data/CAS11_DE_asv_RP.RData"))
load(paste0("./data/CAS13_DE_asv_E.RData"))
load(paste0("./data/CAS13_DE_asv_RP.RData"))
...
# idx <- unique(c(row.names(GH_DE_asv_RP$logFC_P), row.names(GH_DE_asv_E$logFC_P), row.names(CAS_DE_asv_RP$logFC_P), row.names(CAS_DE_asv_E$logFC_P)))
idx <- unique(c(row.names(CAS_DE_asv_RP$logFC_P), row.names(CAS_DE_asv_E$logFC_P)))
...
taxa.mat_temp <- temp.mat[,match(colnames(temp.mat), temp.meta$SampleID)] %>% 
...
save(list = "family_clustered", file = "./data/GLM_clustered_family.RData")
