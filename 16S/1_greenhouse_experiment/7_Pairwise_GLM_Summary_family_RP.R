...
load(paste0("./data/CAS_DE_family.RData"))
...
facet_grid(Soil_Batch ~ tag, scale = "free", space = "free", switch = "both") +
...
mclapply(unique(as.character(taxa.df$new_Order)), function(x){
  ...
  theme(panel.spacing = unit(0.1, "lines"), 
    ...
    ggsave(p, filename = paste0(x.fig.out,"/", x, "_", "_barplot.png"),
           bg="transparent", 
           width=8, 
           height=4,
           units = img, 
  ...
  theme(panel.spacing = unit(0.1, "lines"), 
    ...
    ggsave(p, filename = paste0(x.fig.out,"/", x, "_", "_mean_RA_barplot.png"),
           bg="transparent", 
           width=5, 
           height=3,
           units = img, 
